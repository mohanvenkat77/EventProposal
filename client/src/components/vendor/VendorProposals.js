        ...
        <header id="vendors-header">
          ...
          <section className="right-section" id="filter">
            ...
            >
              <img
                src={
                  require("../../images/1608702_filter_icon (1).svg").default
                }
              />
            </div>
            {showfilters && (
              <ul>
                ...
                <li>
                  <input
                    type="checkbox"
                    id="25001-50000Filter"
                    onChange={(e) => {
                      setFilters((ex) => ({
                        ...ex,
                        ["25001-50000"]: e.target.checked,
                      }));
                ...
                <li>
                  <input
                    type="checkbox"
                    id="50001-75000Filter"
                    onChange={(e) => {
                      setFilters((ex) => ({
                        ...ex,
                        ["50001-75000"]: e.target.checked,
                      }));
                ...
                <li>
                  <input
                    type="checkbox"
                    id="75001-100000Filter"
                    onChange={(e) => {
                      setFilters((ex) => ({
                        ...ex,
                        ["75001-100000"]: e.target.checked,
                      }));
                ...
                <li>
                  <input
                    type="checkbox"
                    id="above100000Filter"
                    onChange={(e) => {
                      setFilters((ex) => ({
                        ...ex,
                        ["> 100000"]: e.target.checked,
                      }));
